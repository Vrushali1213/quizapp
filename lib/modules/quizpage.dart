...
class _TopicListState extends State<QuestionPage>
  ...
  Future<void> ReadJsonData() async {
    final jsondata =
        await rootBundle.rootBundle.loadString('jsonfile/question1.json');
  ...
  @override
  Widget build(BuildContext context) {
    final counterModel = Provider.of<ProductsVM>(context);
